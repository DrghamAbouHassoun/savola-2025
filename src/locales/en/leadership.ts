const leadership = {
    ...
    sections: {
      ...
      esg: {
        ...
        paragraphs: [
          ...
          "This commitment translated into tangible results. Savola Foods delivered a 16.3% reduction in greenhouse gas emissions intensity, supported by efficiency initiatives that also generated <i class='riyal-icon'></i> 104 million in net cost savings, while material losses markedly declined, advancing more circular and resource-efficient operations. Our social impact efforts continued to advance through strong partnerships, enabling the redistribution of food valued at over <i class='riyal-icon'></i> 17 million during the Hajj season, delivering community programs to more than 16,700 beneficiaries and allocating a <i class='riyal-icon'></i> 5 million financing portfolio in partnership with the Social Development Bank to support SME development. Together, these achievements underscore Savola’s commitment to responsible growth, environmental stewardship and long-term societal value. These efforts reinforce our commitment to responsible growth, environmental stewardship and positive societal impact.",
        ],
      },
    },
  ...
  cfo: {
    ...
    introFinancials:
      "Group revenue increased to <i class='riyal-icon'></i> 26.1 billion, reflecting steady performance across both food and retail segments. Net income attributable to shareholders amounted to <i class='riyal-icon'></i> 874 million, compared to <i class='riyal-icon'></i> 9.97 billion in the prior year, which included the one-off gain from the distribution of the Almarai investment. On a normalized basis, adjusted net income rose to <i class='riyal-icon'></i> 539 million from <i class='riyal-icon'></i> 296 million in FY2024, underscoring improvement in underlying operating performance and earnings quality. Operating cash flow remained solid at <i class='riyal-icon'></i> 1.07 billion, supporting continued investment in core operations while maintaining balance sheet discipline.",
    sections: {
      strengthenedPosition: {
        ...
        paragraphs: [
          ...
          "Total equity increased to <i class='riyal-icon'></i> 6.47 billion at year-end. Borrowings declined significantly compared to historical levels. After deducting term deposits and investments in government Sukuk, net debt reflects a strengthened and manageable leverage aligned with the Group’s long-term risk parameters.",
      ...
      retail: {
        title: "Retail",
        paragraphs: [
          "Panda Retail Company delivered revenue growth of 6.6% to <i class='riyal-icon'></i> 11.3 billion, supported by measured store expansion and continued execution of the CXR program.",
      ...
      turkey: {
        ...
        paragraphs: [
          "During the year, our edible oils business in Turkey was merged with a leading integrated agribusiness player, resulting in a 15% equity stake in the enlarged entity. The transaction was completed without cash outflow and resulted in a net gain of <i class='riyal-icon'></i> 33.9 million.",
