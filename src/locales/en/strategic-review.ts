const strategicReview = {
  businessModel: {
    pageTitle: "Strategy and Business Model",
    title: "A Focused Model that aims for Sustainable Growth",
    desc: "Savola’s business model and strategy are built around focused investment in food and retail. We allocate capital selectively, set clear strategic and financial targets for our portfolio companies and actively monitor performance within a robust governance framework.",
    ourStrengths: {
      title: "Our Strengths",
      items: [
        {
          title: "Strategic Focus",
          desc: "Savola focuses its investments through a long-term consumer trend-driven lens with a particular emphasis on the food and retail sectors. The Group strategically allocates capital to capitalize on evolving market dynamics, consumer preferences and emerging trends, aiming to generate sustained value growth in these key industries.",
        },
        {
          title: "Strong Governance Framework",
          desc: "A robust governance and transparency framework, prioritized throughout Savola’s history and values, building shareholder trust.",
        },
        {
          title: "Infrastructure and Consumer Access",
          desc: "Through our holdings, Savola touches millions of consumers across the MENAT region through its multi-country operations, strong consumer brand portfolio and its retail network in Saudi Arabia.",
        },
      ],
    },
    ourChallenges: {
      ...
      items: [
        {
          ...
          desc: `
            Savola’s focus as a strategic shareholder is to implement best practices across its portfolio to ensure:<br />
            <ul>
              <li>Alignment of incentives among stakeholders</li>
              <li> Selection of the right leaders and management teams to deliver on strategic and operational targets</li>
            </ul>
          `,
        },
        {
          title: "Setting Targets and Monitoring Performance",
          desc: "Savola has the tools required for effective performance management across its portfolio. This includes both short-term and long-term strategic, operational and financial KPIs, with periodic reviews and a proactive approach that prioritizes the long-term best interest of the business and shareholder value.",
        },
        {
          title: "Capital Allocation ",
          desc: "Savola aims to maximize return on investment by deploying or redeploying capital to enhance shareholder returns and create additional value by gaining access to segments with long-term potential within the food and retail space. The primary objective is to generate sustainable excess returns over the cost of capital.",
        },
        {
          title: "Long-Term Strategic Planning",
          desc: "Savola believes that in addition to managing our capital and operating companies for performance and long-term sustainability at the subsidiary level, our role is to look at our markets, our holdings and our operations with a view to realize our ambition of maximizing our share of consumer spending across our markets profitably over the long-term horizon.",
        },
      ],
    },
    ourCorporateValue: {
      ...
      items: [
        {
          desc: "Our values underpin everything we do; they are a blueprint for concrete actions we take as individuals, as a team and as a company, every day.",
        },
        {
  ...
  journey: {
    ...
    section1: {
      ...
      whatChanged: {
        ...
        card1: {
          title: "Core Food Platform",
          subtitle: "Food-focused operating model",
          list: [
